...
This model had all refusal to answer responses removed from training. Try it (MacOS) with:

- `cd chat;./gpt4all-lora-quantized-OSX-m1 -m gpt4all-lora-unfiltered-quantized.bin`

This model had all refusal to answer responses removed from training. Try it (Windows) with:
